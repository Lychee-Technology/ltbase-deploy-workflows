...
assert_file_contains "${ROOT_DIR}/.github/workflows/preview-stack.yml" "go_version_file: \${{ format('blueprint/{0}/go.mod', inputs.working_directory) }}"
assert_file_contains "${ROOT_DIR}/.github/workflows/preview-stack.yml" "cache_dependency_path: \${{ format('blueprint/{0}/go.sum', inputs.working_directory) }}"
...
assert_file_contains "${ROOT_DIR}/.github/workflows/preview-stack.yml" "provenance_path: blueprint/__ref__/template-provenance.json"
...
assert_file_contains "${ROOT_DIR}/.github/workflows/rollout-hop.yml" "go_version_file: \${{ format('blueprint/{0}/go.mod', inputs.working_directory) }}"
assert_file_contains "${ROOT_DIR}/.github/workflows/rollout-hop.yml" "cache_dependency_path: \${{ format('blueprint/{0}/go.sum', inputs.working_directory) }}"
...
assert_file_contains "${ROOT_DIR}/.github/workflows/rollout-hop.yml" "provenance_path: blueprint/__ref__/template-provenance.json"
...
assert_file_contains "${ROOT_DIR}/.github/workflows/rollout-hop.yml" "cloudflare_account_id"
...
assert_file_not_contains "${ROOT_DIR}/.github/workflows/rollout-hop.yml" "Aggregate control plane UI config"
assert_file_contains "${ROOT_DIR}/.github/workflows/rollout-hop.yml" "if: \${{ inputs.controlplane_ui_pages_project != '' && inputs.controlplane_ui_runtime_config_json != '' }}"
...
assert_file_contains "${ROOT_DIR}/.github/workflows/rollout-hop.yml" "manifest_path: \${{ steps.download.outputs.manifest_path }}"
assert_file_contains "${ROOT_DIR}/.github/workflows/rollout-hop.yml" "runtime_config_json: \${{ inputs.controlplane_ui_runtime_config_json }}"
assert_file_contains "${ROOT_DIR}/.github/workflows/rollout-hop.yml" "cloudflare_pages_project: \${{ inputs.controlplane_ui_pages_project }}"
assert_file_contains "${ROOT_DIR}/.github/workflows/rollout-hop.yml" "cloudflare_account_id: \${{ inputs.cloudflare_account_id }}"
